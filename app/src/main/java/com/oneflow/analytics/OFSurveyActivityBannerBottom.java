    ...
    protected void onStart() {
        ...
        closeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                OFOneFlowSHP ofs = new OFOneFlowSHP(OFSurveyActivityBannerBottom.this);
                ...
                if (surveyResponseChildren == null || surveyResponseChildren.size() == 0) {
                    ...
                    if (!closedSurveyList.contains(selectedSurveyId)) {
                        ...
                        OFEventController ec = OFEventController.getInstance(OFSurveyActivityBannerBottom.this);
                ...
                OFSurveyActivityBannerBottom.this.finish();
